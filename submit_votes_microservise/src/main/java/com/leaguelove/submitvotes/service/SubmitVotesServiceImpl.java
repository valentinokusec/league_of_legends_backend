...
import com.leaguelove.submitvotes.domain.UserModel;
import com.leaguelove.submitvotes.domain.VoteModel;
...
public JSONArray getVotes(String name) {
	// TODO Auto-generated method stub
		...
		movies_list = db.findByIndex("{selector: { match_id: "+2819295746L+",to:"+name_uppercase+"}}",
				VoteModel.class);
	
		 JSONArray last_match=new JSONArray(movies_list.toString());
		return last_match;
